...
from ska_jama_jira_integration.jama.transformers import parse_html
...
def test_parse_html():
    html1 = """<p>&nbsp;</p>
    <p>&nbsp;</p>
    <p><strong>Table 5 Predefined SPEAD items</strong></p>
    <p>&nbsp;</p>
    <table cellspacing="0">
        <tbody>
            <tr>
                ...
                <td rowspan="5">
                <p>The heap counter consists of a 24 bits packet counter. After data has been requested by SW, the first SPEAD packet has packet counter cleared to 0; the packet counter is incremented by 1 at each transmitted SPEAD packet. In Continuous Channel Data mode packet counter wraps to 0.</p>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                <p>Length in bytes of included SPEAD payload. Value reflects the register value programmed by SW.</p>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                <p><strong>0x1011</strong></p>
                </td>
                <td>
                <p>center_frequency</p>
                </td>
                <td>
                <p>Channel Center Frequency in Hz.</p>
                </td>
                <td>&nbsp;</td>
            </tr>
        </tbody>
